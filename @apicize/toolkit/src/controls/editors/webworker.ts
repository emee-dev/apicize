import('ace-linters/build/service-manager').then(
    ({ ServiceManager }) => {
        let manager = new ServiceManager(self);

        // manager.registerService("typescript", {
        //     features: { completion: true, completionResolve: false, diagnostics: true, format: false, hover: false, documentHighlight: false, signatureHelp: false },
